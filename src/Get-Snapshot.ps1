...
.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cimi/Client/Get-Snapshot/
...
#>
[CmdletBinding(
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cimi/Client/Get-Snapshot/'
	,
...
BEGIN 
{
	...
	Log-Debug $fn ("CALL. Id '{0}' Name '{1}'; MachineId '{2}'." -f $Id, $Name, $MachineId) -fac 1;
	...
	$invokeAction = 'GetSnapshot';
	$collectionName = 'MachineImages';
	if($PSCmdlet.ParameterSetName -ne 'id') 
	{
		Contract-Requires(!!$MachineId);
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-Snapshot; } 

# SIG # Begin signature block
# MIIXDwYJKoZIhvcNAQcCoIIXADCCFvwCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0gsLsjr9DcHWT3oWeXiVjsWa
# C5qgghHCMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRoR90TYcOlGhJa
# cjF7MQEJ95a8RTANBgkqhkiG9w0BAQEFAASCAQC3IqaFrEfqBaqxigR7qhNlrXYn
# 4vOD31mIFR6Pa+Si2FnJeOokFDWsY7hXysIh0fUoqKyKRb8nS7XzFOtkmswjYOTE
# rpYlZ4GA0tNVzlmKkvKWcJhWamVm9gQpJUGgzZ+oGdDJIT/Db5fa2wGxea7S1eRq
# RBo1QeagyQl6qEtxJiqmgYXqIwbTnB/ICFMGVLplIFBxarOiMOEWc9ioehZscaUr
# xnXVpr9dJ6hxet/NSY/nzW71atMqris1/0Fg943JQggrzo3Mg5kuJYd9FdBXRANB
# 7u4grsR+e631zTzFzKEVEng1K/WdvxZKxIWnDQf7thWy5bRaFemT1UYssrI7oYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEh1pmnZJc+8fhCfukZzFNBFDAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE2
# MDcxNjE2MTQzM1owIwYJKoZIhvcNAQkEMRYEFMsgNjKvw8NEyxrdWQl6+krjZW8n
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUY7gvq2H1g5CWlQULACScUCkz
# 7HkwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# 1pmnZJc+8fhCfukZzFNBFDANBgkqhkiG9w0BAQEFAASCAQA/X9/Smf4gq209c2rn
# e8CuCMSklNQQw864F4YITuvW3t+eCAhWmxgxGmU1LXgBC7Ly38A5tD0jDbi57Ujj
# LLIFI+zMQQcEbnAxx+yf0OGvBEqNnImYfdGy2RMEfz8dGAiagOziUnC+lKmgtyBc
# O3iD6SGPMOQ7k5myGTWq+Ol20E9soxg6fqnMXKPE1txuNRthU/zq3FddB2CCxA+S
# D9YV9o9K9gmPbAp7T7q3yHDgAThQle1RpW2IeAGmQXHWjF7/pPKkKvSPQzzCTHDn
# 3mu/u+GD2LfHCMPDxx4L6D5g9dKMHnF/ojrJQ+2IJ6ZB/unFccGRO/K7U9s7J9VG
# w88I
